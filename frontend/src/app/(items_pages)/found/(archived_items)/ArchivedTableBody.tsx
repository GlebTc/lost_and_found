...
import EditItemForm from "../(found_items)/EditItemForm"
import Modal from "@/app/components/reusable/Modal";
import ReleaseItemForm from "../(found_items)/ReleaseItemForm";
...
const ArchivedTableBody: React.FC<Props> = ({ items, handleDeleteItemClick, user }) => {
...
export default ArchivedTableBody;
